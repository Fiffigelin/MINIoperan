...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 10 jan 2023 kl 17:47
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SelectEmail` (IN `inputemail` VARCHAR(32))   BEGIN
	SELECT * FROM customers WHERE customers.email = inputemail;
END$$
...
(16, 'Jason', 'Smith', 'smith2mail.com', '0706271638', '');
